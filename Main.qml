...
/*!
    sTOnSCipAP - A further experiment with qml and the Ubuntu SDK, this time using pictures & audio
*/
...
MainView {
    ...
    applicationName: "stonscipap-v0-1.username"
    ...
    property var winnames: [ "Everyone", "Lune", "Wolfman" ]
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        Label {
                            id: wordses
                            text: i18n.tr("sTOnsCipAP - The Electronic Decision Maker")
                            anchors.centerIn: parent
                            color: UbuntuColors.orange
                            font.pixelSize: units.gu(2)
        ...
        Page {
            ...
            Rectangle {
                ...
                Flickable {
                    ...
                    contentHeight: page1wrapper.height * 2
