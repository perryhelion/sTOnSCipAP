...
UBUNTU_TRANSLATION_DOMAIN="stonscipap.phelion"
...
aptest.commands = bash $$PWD/sTOnSCipAP/tests/autopilot/run
aptest.depends  = sub-sTOnSCipAP

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/sTOnSCipAP/tests/unit
unittest.depends  = sub-sTOnSCipAP
